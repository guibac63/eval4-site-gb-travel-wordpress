...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210529_gbtravel_91601651c79775ed7897_20210529072912_archive.zip';
	const ARCHIVE_SIZE		 = '75925161';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9160165-29072912';
    const SECONDARY_PACKAGE_HASH = '3702bd8-29072912';
	const VERSION			 = '1.4.1';
