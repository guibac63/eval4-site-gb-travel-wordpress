                ...
                <?php if ( ! empty( $blog_info ) ) : ?>
                  <?php if( get_theme_mod('tafri_travel_show_site_title',true) != ''){ ?>
                    <?php if ( is_front_page() && is_home() ) : ?>
                      <h1 class="site-title m-0 text-lg-center text-left text-capitalize"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="text-capitalize"><?php bloginfo( 'name' ); ?></a></h1>
                    <?php else : ?>
                      <p class="site-title m-0 text-lg-center text-left"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="text-capitalize"><?php bloginfo( 'name' ); ?></a></p>
                    <?php endif; ?>
                  <?php }?>
                <?php endif; ?>
                <?php
